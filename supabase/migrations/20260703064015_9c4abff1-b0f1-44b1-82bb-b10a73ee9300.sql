ALTER TABLE public.organizations ADD COLUMN IF NOT EXISTS reviews_enabled boolean NOT NULL DEFAULT true;
...
BEGIN
  ...
  -- Se avaliações desativadas, avaliacao_url vira string vazia
  ...
  INSERT INTO whatsapp_outbox (organization_id, order_id, event_type, to_number, message, status)
