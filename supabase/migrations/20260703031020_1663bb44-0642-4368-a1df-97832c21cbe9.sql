...
BEGIN
  ...
  -- Se nome vazio ou só dígitos (fallback do telefone), usa "Cliente"
  ...
  -- Extrai campos das notes para o template rico do dono
  ...
  -- Monta lista de itens: "  • 2x Pizza — R$ 30,00"
  ...
  -- Remove linhas cujo conteúdo após ":" ficou vazio (ex.: "📍 *Endereço:* ")
  v_out := '';
  ...
  v_message := regexp_replace(rtrim(v_out, E'\n'), E'\n{3,}', E'\n\n', 'g');
