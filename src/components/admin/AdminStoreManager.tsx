...
import { ArrowLeft, Store, UtensilsCrossed, History, Tag, BarChart2, Grid3X3, Package, Wallet, Settings, FileText, MapPin } from "lucide-react";
...
export default function AdminStoreManager({ org, onBack }: AdminStoreManagerProps) {
  ...
  // Build a minimal Organization object for components that need it
  const orgForComponents: Organization = {
    id: org.id,
    name: org.name,
    slug: org.slug,
    emoji: org.emoji,
