        ...
        <div ref={barsRef} className="grid md:grid-cols-2 gap-8 mb-16 items-end max-w-3xl mx-auto">
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm font-bold uppercase tracking-wider">
              ...
              <CountUpDisplay to={27} suffix="% taxa" className="text-destructive" trigger={inView} />
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm font-bold uppercase tracking-wider">
              ...
              <CountUpDisplay to={100} suffix="% pra você" className="text-emerald-600" trigger={inView} />
            </div>
