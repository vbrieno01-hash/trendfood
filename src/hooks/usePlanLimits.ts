...
type Feature = "kds" | "caixa" | "cupons" | "bestsellers" | "waiter" | "history_full" | "multi_unit" | "reports" | "addons" | "stock_ingredients" | "online_payment" | "pricing" | "loyalty" | "ai_bot" | "delivery_neighborhoods";
...
const FEATURE_ACCESS: Record<Plan, Record<Feature, boolean>> = {
  free: {
    ...
    ai_bot: false, delivery_neighborhoods: false,
  },
  pro: {
    ...
    ai_bot: true, delivery_neighborhoods: true,
  },
  enterprise: {
    kds: true, caixa: true, cupons: true, bestsellers: true,
